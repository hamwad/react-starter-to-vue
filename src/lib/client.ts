...
export function Environment(name: string): BaseURL {
    return `https://${name}-react-starter-to-vue-ecv2.encr.app`
}
...
/**
 * Client is an API client for the react-starter-to-vue-ecv2 Encore application.
 */
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "react-starter-to-vue-ecv2-Generated-TS-Client (Encore/v1.46.4)";
        }
